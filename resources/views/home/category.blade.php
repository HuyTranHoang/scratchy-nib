        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col d-xxl-flex justify-content-xxl-center">
                    <button class="btn btn-primary-color mx-1 mb-2 ">ALL</button>
                    <button class="btn btn-primary-color mx-1 mb-2 ">Traditional Calligraphy</button>
                    <button class="btn btn-primary-color mx-1 mb-2 ">Contemporary Calligraphy</button>
                    <button class="btn btn-primary-color mx-1 mb-2 ">Hand-lettering & Design</button>
                    <button class="btn btn-primary-color mx-1 mb-2 ">Modern Calligraphy</button>
                    <button class="btn btn-primary-color mx-1 mb-2 ">Modern Calligraphy</button>
                </div>
            </div>
        </div>
